...
{
    public class BiasedToBottomProvider : IntProvider
    {
        public override string Type => "biased_to_bottom";

        public int MinInclusive { get; set; }

        public int MaxInclusive { get; set; }

        public BiasedToBottomProvider() { }

        public BiasedToBottomProvider(int minInclusive, int maxInclusive)
        {
